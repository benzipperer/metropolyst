...
- [example-default.typ](https://github.com/benzipperer/metropolyst/blob/main/typst/examples/example-default.typ) ([PDF](https://github.com/benzipperer/metropolyst/blob/main/typst/examples/example-default.pdf)) - Minimal example using default settings
- [example-custom.typ](https://github.com/benzipperer/metropolyst/blob/main/typst/examples/example-custom.typ) ([PDF](https://github.com/benzipperer/metropolyst/blob/main/typst/examples/example-custom.pdf)) - Comprehensive example demonstrating all configuration options
- [example-epi.typ](https://github.com/benzipperer/metropolyst/blob/main/typst/examples/example-epi.typ) ([PDF](https://github.com/benzipperer/metropolyst/blob/main/typst/examples/example-epi.pdf)) - Example using the built-in EPI brand preset
